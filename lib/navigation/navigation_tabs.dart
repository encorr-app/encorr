...
// Seerr fork addition — plain string (no slang i18n regeneration for the fork).
String _getRequestsLabel() => 'Discover+';
...
const allNavigationTabs = [
  ...
  // Seerr discover/requests tab — only visible when a Seerr server is configured.
  NavigationTab(
