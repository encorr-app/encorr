...
class _TranslationsSettingsPt extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Apoie o Encorr';
	...
	@override String get importSettingsInvalidFile => 'Este arquivo não é uma exportação válida do Encorr';
	...
	@override String get startInFullscreenDescription => 'Abrir o Encorr em modo de tela cheia ao iniciar';
	...
	@override String get startupSectionDescription => 'Escolha qual seção o Encorr abre ao iniciar';
...
class _TranslationsProfilesPt extends TranslationsProfilesEn {
	...
	// Translations
	@override String get addEncorrProfile => 'Adicionar perfil Encorr';
...
class _TranslationsConnectionsPt extends TranslationsConnectionsEn {
	...
	@override String editJellyfinIntro({required Object serverName}) => 'Adicione ou remova URLs de ${serverName}. O Encorr usará a URL acessível com a menor latência.';
}
...
class _TranslationsTraktPt extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'Encorr deixará de enviar eventos ao Trakt. Você pode reconectar quando quiser.';
	...
	@override String get watchedSyncDescription => 'Ao marcar itens como assistidos no Encorr, eles também serão marcados no Trakt.';
}
...
class _TranslationsTrackersPt extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Encorr deixará de atualizar ${service}. Reconecte quando quiser.';
...
class _TranslationsCompanionRemotePairingPt extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => 'Dispositivos Encorr com a mesma conta Plex aparecem aqui';
	...
	@override String get noDevicesHint => 'Abra Encorr no desktop e use o mesmo WiFi';
	...
	@override String get sessionNotFound => 'Dispositivo não encontrado. Verifique se Encorr está rodando no host.';
...
class _TranslationsTrackersDeviceCodePt extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => 'Ativar Encorr no ${service}';
...
extension on TranslationsPt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.supportDeveloper' => 'Apoie o Encorr',
			...
			'settings.importSettingsInvalidFile' => 'Este arquivo não é uma exportação válida do Encorr',
			...
			'settings.startInFullscreenDescription' => 'Abrir o Encorr em modo de tela cheia ao iniciar',
			...
			'settings.startupSectionDescription' => 'Escolha qual seção o Encorr abre ao iniciar',
			...
			'profiles.addEncorrProfile' => 'Adicionar perfil Encorr',
			...
			'connections.editJellyfinIntro' => ({required Object serverName}) => 'Adicione ou remova URLs de ${serverName}. O Encorr usará a URL acessível com a menor latência.',
			...
			'companionRemote.pairing.discoveryDescription' => 'Dispositivos Encorr com a mesma conta Plex aparecem aqui',
			...
			'companionRemote.pairing.noDevicesHint' => 'Abra Encorr no desktop e use o mesmo WiFi',
			...
			'companionRemote.pairing.sessionNotFound' => 'Dispositivo não encontrado. Verifique se Encorr está rodando no host.',
			...
			'trakt.disconnectConfirmBody' => 'Encorr deixará de enviar eventos ao Trakt. Você pode reconectar quando quiser.',
			...
			'trakt.watchedSyncDescription' => 'Ao marcar itens como assistidos no Encorr, eles também serão marcados no Trakt.',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'Encorr deixará de atualizar ${service}. Reconecte quando quiser.',
			'trackers.connectFailed' => ({required Object service}) => 'Não foi possível conectar ao ${service}. Tente novamente.',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => 'Ativar Encorr no ${service}',
