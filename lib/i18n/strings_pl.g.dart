...
class _TranslationsSettingsPl extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Wesprzyj Encorr';
	...
	@override String get importSettingsInvalidFile => 'Ten plik nie jest prawidłowym eksportem Encorr';
	...
	@override String get startInFullscreenDescription => 'Otwiera Encorr w trybie pełnoekranowym przy uruchomieniu';
	...
	@override String get startupSectionDescription => 'Wybierz, którą sekcję Encorr otwiera przy uruchomieniu';
...
class _TranslationsProfilesPl extends TranslationsProfilesEn {
	...
	// Translations
	@override String get addEncorrProfile => 'Dodaj profil Encorr';
...
class _TranslationsConnectionsPl extends TranslationsConnectionsEn {
	...
	@override String editJellyfinIntro({required Object serverName}) => 'Dodaj lub usuń adresy URL dla ${serverName}. Encorr użyje osiągalnego URL-a o najniższym opóźnieniu.';
}
...
class _TranslationsTraktPl extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'Encorr przestanie wysyłać zdarzenia do Trakt. Możesz połączyć ponownie w dowolnym momencie.';
	...
	@override String get watchedSyncDescription => 'Gdy oznaczysz pozycje jako obejrzane w Encorr, zostaną też oznaczone w Trakt.';
}
...
class _TranslationsTrackersPl extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Encorr przestanie aktualizować ${service}. Połącz ponownie w dowolnym momencie.';
...
class _TranslationsCompanionRemotePairingPl extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => 'Urządzenia Encorr z tym samym kontem Plex pojawią się tutaj';
	...
	@override String get noDevicesHint => 'Otwórz Encorr na komputerze i użyj tego samego WiFi';
	...
	@override String get sessionNotFound => 'Nie znaleziono urządzenia. Upewnij się, że Encorr działa na hoście.';
...
class _TranslationsTrackersDeviceCodePl extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => 'Aktywuj Encorr w ${service}';
...
extension on TranslationsPl {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.supportDeveloper' => 'Wesprzyj Encorr',
			...
			'settings.importSettingsInvalidFile' => 'Ten plik nie jest prawidłowym eksportem Encorr',
			...
			'settings.startInFullscreenDescription' => 'Otwiera Encorr w trybie pełnoekranowym przy uruchomieniu',
			...
			'settings.startupSectionDescription' => 'Wybierz, którą sekcję Encorr otwiera przy uruchomieniu',
			...
			'profiles.addEncorrProfile' => 'Dodaj profil Encorr',
			...
			'connections.editJellyfinIntro' => ({required Object serverName}) => 'Dodaj lub usuń adresy URL dla ${serverName}. Encorr użyje osiągalnego URL-a o najniższym opóźnieniu.',
			...
			'companionRemote.pairing.discoveryDescription' => 'Urządzenia Encorr z tym samym kontem Plex pojawią się tutaj',
			...
			'companionRemote.pairing.noDevicesHint' => 'Otwórz Encorr na komputerze i użyj tego samego WiFi',
			...
			'companionRemote.pairing.sessionNotFound' => 'Nie znaleziono urządzenia. Upewnij się, że Encorr działa na hoście.',
			...
			'trakt.disconnectConfirmBody' => 'Encorr przestanie wysyłać zdarzenia do Trakt. Możesz połączyć ponownie w dowolnym momencie.',
			...
			'trakt.watchedSyncDescription' => 'Gdy oznaczysz pozycje jako obejrzane w Encorr, zostaną też oznaczone w Trakt.',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'Encorr przestanie aktualizować ${service}. Połącz ponownie w dowolnym momencie.',
			'trackers.connectFailed' => ({required Object service}) => 'Nie udało się połączyć z ${service}. Spróbuj ponownie.',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => 'Aktywuj Encorr w ${service}',
