...
class _TranslationsSettingsSv extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Stöd Encorr';
	...
	@override String get importSettingsInvalidFile => 'Denna fil är inte en giltig Encorr-export';
	...
	@override String get startInFullscreenDescription => 'Öppna Encorr i helskärm vid start';
	...
	@override String get startupSectionDescription => 'Välj vilken sektion Encorr öppnar vid start';
...
class _TranslationsProfilesSv extends TranslationsProfilesEn {
	...
	// Translations
	@override String get addEncorrProfile => 'Lägg till Encorr-profil';
...
class _TranslationsConnectionsSv extends TranslationsConnectionsEn {
	...
	@override String editJellyfinIntro({required Object serverName}) => 'Lägg till eller ta bort URL:er för ${serverName}. Encorr använder den nåbara URL:en med lägst latens.';
}
...
class _TranslationsTraktSv extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'Encorr slutar skicka händelser till Trakt. Du kan återansluta när som helst.';
	...
	@override String get watchedSyncDescription => 'När du markerar något som tittat i Encorr markeras det också på Trakt.';
}
...
class _TranslationsTrackersSv extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Encorr slutar uppdatera ${service}. Återanslut när som helst.';
...
class _TranslationsCompanionRemotePairingSv extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => 'Encorr-enheter med samma Plex-konto visas här';
	...
	@override String get noDevicesHint => 'Öppna Encorr på desktop och använd samma WiFi';
	...
	@override String get sessionNotFound => 'Enhet hittades inte. Kontrollera att Encorr körs på värden.';
...
class _TranslationsTrackersDeviceCodeSv extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => 'Aktivera Encorr på ${service}';
...
extension on TranslationsSv {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.supportDeveloper' => 'Stöd Encorr',
			...
			'settings.importSettingsInvalidFile' => 'Denna fil är inte en giltig Encorr-export',
			...
			'settings.startInFullscreenDescription' => 'Öppna Encorr i helskärm vid start',
			...
			'settings.startupSectionDescription' => 'Välj vilken sektion Encorr öppnar vid start',
			...
			'profiles.addEncorrProfile' => 'Lägg till Encorr-profil',
			...
			'connections.editJellyfinIntro' => ({required Object serverName}) => 'Lägg till eller ta bort URL:er för ${serverName}. Encorr använder den nåbara URL:en med lägst latens.',
			...
			'companionRemote.pairing.discoveryDescription' => 'Encorr-enheter med samma Plex-konto visas här',
			...
			'companionRemote.pairing.noDevicesHint' => 'Öppna Encorr på desktop och använd samma WiFi',
			...
			'companionRemote.pairing.sessionNotFound' => 'Enhet hittades inte. Kontrollera att Encorr körs på värden.',
			...
			'trakt.disconnectConfirmBody' => 'Encorr slutar skicka händelser till Trakt. Du kan återansluta när som helst.',
			...
			'trakt.watchedSyncDescription' => 'När du markerar något som tittat i Encorr markeras det också på Trakt.',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'Encorr slutar uppdatera ${service}. Återanslut när som helst.',
			'trackers.connectFailed' => ({required Object service}) => 'Kunde inte ansluta till ${service}. Försök igen.',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => 'Aktivera Encorr på ${service}',
