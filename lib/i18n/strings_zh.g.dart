...
class _TranslationsSettingsZh extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => '支持 Encorr';
	...
	@override String get importSettingsInvalidFile => '此文件不是有效的 Encorr 设置导出';
	...
	@override String get startInFullscreenDescription => '启动时以全屏模式打开 Encorr';
	...
	@override String get startupSectionDescription => '选择 Encorr 启动时打开的页面';
...
class _TranslationsProfilesZh extends TranslationsProfilesEn {
	...
	// Translations
	@override String get addEncorrProfile => '添加 Encorr 配置文件';
...
class _TranslationsConnectionsZh extends TranslationsConnectionsEn {
	...
	@override String editJellyfinIntro({required Object serverName}) => '添加或移除 ${serverName} 的 URL。Encorr 会使用可访问且延迟最低的 URL。';
}
...
class _TranslationsTraktZh extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'Encorr 将停止向 Trakt 发送事件。你可随时重新连接。';
	...
	@override String get watchedSyncDescription => '在 Encorr 中将内容标记为已观看时，也会在 Trakt 上标记为已观看。';
}
...
class _TranslationsTrackersZh extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Encorr 将停止更新 ${service}。可随时重新连接。';
...
class _TranslationsCompanionRemotePairingZh extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => '使用同一 Plex 账号的 Encorr 设备会显示在这里';
	...
	@override String get noDevicesHint => '在桌面端打开 Encorr 并使用同一 WiFi';
	...
	@override String get sessionNotFound => '未找到设备。请确认 Encorr 正在主机上运行。';
...
class _TranslationsTrackersDeviceCodeZh extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => '在 ${service} 上激活 Encorr';
...
extension on TranslationsZh {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.title' => '设置',
			'settings.supportDeveloper' => '支持 Encorr',
			...
			'settings.importSettingsInvalidFile' => '此文件不是有效的 Encorr 设置导出',
			...
			'settings.startInFullscreenDescription' => '启动时以全屏模式打开 Encorr',
			...
			'settings.startupSectionDescription' => '选择 Encorr 启动时打开的页面',
			...
			'profiles.addEncorrProfile' => '添加 Encorr 配置文件',
			...
			'connections.editJellyfinIntro' => ({required Object serverName}) => '添加或移除 ${serverName} 的 URL。Encorr 会使用可访问且延迟最低的 URL。',
			'discover.title' => '发现',
			...
			'companionRemote.pairing.discoveryDescription' => '使用同一 Plex 账号的 Encorr 设备会显示在这里',
			...
			'companionRemote.pairing.noDevicesHint' => '在桌面端打开 Encorr 并使用同一 WiFi',
			...
			'companionRemote.pairing.sessionNotFound' => '未找到设备。请确认 Encorr 正在主机上运行。',
			...
			'trakt.disconnectConfirmBody' => 'Encorr 将停止向 Trakt 发送事件。你可随时重新连接。',
			'trakt.scrobble' => '实时 Scrobble',
			'trakt.scrobbleDescription' => '在播放时向 Trakt 发送播放、暂停和停止事件。',
			'trakt.watchedSync' => '同步已观看状态',
			'trakt.watchedSyncDescription' => '在 Encorr 中将内容标记为已观看时，也会在 Trakt 上标记为已观看。',
			'trackers.title' => '追踪器',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'Encorr 将停止更新 ${service}。可随时重新连接。',
			'trackers.connectFailed' => ({required Object service}) => '无法连接到 ${service}。请重试。',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => '在 ${service} 上激活 Encorr',
