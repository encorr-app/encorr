...
class _TranslationsSettingsKo extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Encorr 후원하기';
	...
	@override String get importSettingsInvalidFile => '유효한 Encorr 설정 내보내기 파일이 아닙니다';
	...
	@override String get startInFullscreenDescription => '실행 시 Encorr를 전체화면 모드로 엽니다';
	...
	@override String get startupSectionDescription => 'Encorr 실행 시 열릴 섹션을 선택합니다';
...
class _TranslationsProfilesKo extends TranslationsProfilesEn {
	...
	// Translations
	@override String get addEncorrProfile => 'Encorr 프로필 추가';
...
class _TranslationsConnectionsKo extends TranslationsConnectionsEn {
	...
	@override String editJellyfinIntro({required Object serverName}) => '${serverName}의 URL을 추가하거나 제거하세요. Encorr는 연결 가능한 URL 중 지연 시간이 가장 낮은 URL을 사용합니다.';
}
...
class _TranslationsTraktKo extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'Encorr가 Trakt로 이벤트 전송을 중지합니다. 언제든 다시 연결할 수 있습니다.';
	...
	@override String get watchedSyncDescription => 'Encorr에서 시청 완료로 표시한 항목이 Trakt에도 시청 완료로 표시됩니다.';
}
...
class _TranslationsTrackersKo extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Encorr가 ${service} 업데이트를 중지합니다. 언제든 다시 연결할 수 있습니다.';
...
class _TranslationsCompanionRemotePairingKo extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => '같은 Plex 계정의 Encorr 기기가 여기에 표시됩니다';
	...
	@override String get noDevicesHint => '데스크톱에서 Encorr를 열고 같은 WiFi를 사용하세요';
	...
	@override String get sessionNotFound => '기기를 찾을 수 없습니다. 호스트에서 Encorr가 실행 중인지 확인하세요.';
...
class _TranslationsTrackersDeviceCodeKo extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => '${service}에서 Encorr 활성화';
...
extension on TranslationsKo {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.title' => '설정',
			'settings.supportDeveloper' => 'Encorr 후원하기',
			...
			'settings.importSettingsInvalidFile' => '유효한 Encorr 설정 내보내기 파일이 아닙니다',
			...
			'settings.startInFullscreenDescription' => '실행 시 Encorr를 전체화면 모드로 엽니다',
			...
			'settings.startupSectionDescription' => 'Encorr 실행 시 열릴 섹션을 선택합니다',
			...
			'profiles.addEncorrProfile' => 'Encorr 프로필 추가',
			...
			'connections.editJellyfinIntro' => ({required Object serverName}) => '${serverName}의 URL을 추가하거나 제거하세요. Encorr는 연결 가능한 URL 중 지연 시간이 가장 낮은 URL을 사용합니다.',
			'discover.title' => '발견',
			...
			'companionRemote.pairing.discoveryDescription' => '같은 Plex 계정의 Encorr 기기가 여기에 표시됩니다',
			...
			'companionRemote.pairing.noDevicesHint' => '데스크톱에서 Encorr를 열고 같은 WiFi를 사용하세요',
			...
			'companionRemote.pairing.sessionNotFound' => '기기를 찾을 수 없습니다. 호스트에서 Encorr가 실행 중인지 확인하세요.',
			...
			'trakt.disconnectConfirmBody' => 'Encorr가 Trakt로 이벤트 전송을 중지합니다. 언제든 다시 연결할 수 있습니다.',
			'trakt.scrobble' => '실시간 스크로블',
			'trakt.scrobbleDescription' => '재생 중 재생, 일시정지, 정지 이벤트를 Trakt로 전송합니다.',
			'trakt.watchedSync' => '시청 상태 동기화',
			'trakt.watchedSyncDescription' => 'Encorr에서 시청 완료로 표시한 항목이 Trakt에도 시청 완료로 표시됩니다.',
			'trackers.title' => '트래커',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'Encorr가 ${service} 업데이트를 중지합니다. 언제든 다시 연결할 수 있습니다.',
			'trackers.connectFailed' => ({required Object service}) => '${service}에 연결할 수 없습니다. 다시 시도하세요.',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => '${service}에서 Encorr 활성화',
