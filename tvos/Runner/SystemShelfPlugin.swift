...
import TVServices
  ...
  final class SystemShelfPlugin: NSObject, FlutterPlugin {
    private static let channelName = "com.encorr/system_shelf"
    private static let appGroupIdentifier = "group.app.encorr.encorr"
    private static let cacheDataKey = "EncorrSystemShelfCacheData"
    ...
    private static func contentId(from url: URL) -> String? {
      guard url.scheme == "encorr", url.host == "play" else { return nil }
