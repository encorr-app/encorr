 ...
 * full-screen players on `com.encorr/exo_player` and `com.encorr/mpv_player`.
 */
class InlinePlayerPlugin :
  ...
  ActivityAware,
  app.encorr.encorr.shared.PlayerDelegate {

  companion object {
    private const val TAG = "InlinePlayerPlugin"
    private const val METHOD_CHANNEL = "com.encorr/inline_player"
    private const val EVENT_CHANNEL = "com.encorr/inline_player/events"
  }
