...
import app.encorr.encorr.exoplayer.ExoPlayerPlugin
import app.encorr.encorr.inline.InlinePlayerPlugin
import app.encorr.encorr.mpv.MpvPlayerPlugin
import app.encorr.encorr.shared.DeviceQuirks
import app.encorr.encorr.shared.ThemeHelper
import app.encorr.encorr.watchnext.WatchNextPlugin
...
class MainActivity : FlutterActivity() {
  ...
  private val PIP_CHANNEL = "com.encorr/pip"
  private val EXTERNAL_PLAYER_CHANNEL = "com.encorr/external_player"
  private val THEME_CHANNEL = "com.encorr/theme"
  private val DEVICE_CHANNEL = "com.encorr/device"
  private val DEVICE_ADJUSTMENT_CHANNEL = "com.encorr/device_adjustment"
  private val TEXT_INPUT_CHANNEL = "com.encorr/text_input"
  private val APP_EXIT_CHANNEL = "com.encorr/app_exit"
  private val APP_FOREGROUND_CHANNEL = "com.encorr/app_foreground"
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    val prefs = getSharedPreferences("encorr_prefs", Context.MODE_PRIVATE)
  ...
  override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
    ...
    flutterEngine.plugins.add(InlinePlayerPlugin())
        ...
        "openVideo" -> {
          ...
          try {
            ...
            if (filePath.startsWith("http://") || filePath.startsWith("https://")) {
              ...
              uri = FileProvider.getUriForFile(this, "app.encorr.encorr.fileprovider", File(path))
              grantRead = true
            }
    ...
    MethodChannel(flutterEngine.dartExecutor.binaryMessenger, THEME_CHANNEL).setMethodCallHandler { call, result ->
      when (call.method) {
        ...
        "setSplashTheme" -> {
          ...
          getSharedPreferences("encorr_prefs", Context.MODE_PRIVATE)
