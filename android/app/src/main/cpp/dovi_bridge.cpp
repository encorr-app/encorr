...
extern "C" JNIEXPORT jint JNICALL Java_app_encorr_encorr_exoplayer_DoviBridge_nativeConvertDv7RpuToDv81(
...
Java_app_encorr_encorr_exoplayer_DoviBridge_nativeIsConversionPathReady(JNIEnv*, jclass) {
#if DOVI_REAL_LINKED
  return JNI_TRUE;
#else
  return JNI_FALSE;
...
Java_app_encorr_encorr_exoplayer_DoviBridge_nativeGetBridgeVersion(JNIEnv* env, jclass) {
